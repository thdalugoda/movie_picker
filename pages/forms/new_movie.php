		    ...
		    <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <h3 class="box-title">Movie Information</h3>
				 ...
				 <div class="box-header">
                  <?php if (isset($_POST['add'])) { $db->addmovie(); }?>
                </div>
                <!-- form start -->
...
<div class="form-group ">	
					...
					<div class="form-group ">	
                      <label>Model Grades</label>
                       <input type="text" name="m_grades" class="form-control">
                    </div>-->
					  </th>
					...
					<!--<label>USP's</label>
					<textarea id="editor1" name="usp" rows="10" cols="80">
                                            
                    </textarea>-->
					<div class="form-group" >
                      <label>Movie Poster (512px X 512px)</label>
      ...
      <footer class="main-footer">
       ...
       <strong>Developed & Powered By <a href="">Smart Movie</a>.</strong> 
      </footer>
    </div><!-- ./wrapper -->
